...
RUN sudo dpkg -i libttspico-data_1.0+git20130326-3_all.deb
RUN sudo dpkg -i libttspico0_1.0+git20130326-3_armhf.deb
RUN sudo dpkg -i libttspico-utils_1.0+git20130326-3_armhf.deb
